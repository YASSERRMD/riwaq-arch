...
This document provides an architectural overview of the riwaq-arch codebase, consisting of 84 modules across 84 files with 18442 total lines of code.
...
graph TB
    ...
    subgraph jetbrains_plugin [jetbrains-plugin]
        jetbrains_plugin_main_kotlin_com_riwaq_arch_toolwindow_ArchitectureToolWindowFactory[jetbrains-plugin/main/kotlin/com/riwaq/arch/toolwindow/ArchitectureToolWindowFactory]
        ...
        jetbrains_plugin_main_kotlin_com_riwaq_arch_statusbar_RiwaqStatusBarWidget[jetbrains-plugin/main/kotlin/com/riwaq/arch/statusbar/RiwaqStatusBarWidget]
        jetbrains_plugin_main_kotlin_com_riwaq_arch_listeners_ProjectManagerListener[jetbrains-plugin/main/kotlin/com/riwaq/arch/listeners/ProjectManagerListener]
        jetbrains_plugin_main_kotlin_com_riwaq_arch_actions_RestartServerAction[jetbrains-plugin/main/kotlin/com/riwaq/arch/actions/RestartServerAction]
        jetbrains_plugin_main_kotlin_com_riwaq_arch_settings_RiwaqProjectConfigurable[jetbrains-plugin/main/kotlin/com/riwaq/arch/settings/RiwaqProjectConfigurable]
        ...
        jetbrains_plugin_main_kotlin_com_riwaq_arch_client_RiwaqClient[jetbrains-plugin/main/kotlin/com/riwaq/arch/client/RiwaqClient]
        ...
        jetbrains_plugin_main_kotlin_com_riwaq_arch_settings_RiwaqSettings[jetbrains-plugin/main/kotlin/com/riwaq/arch/settings/RiwaqSettings]
        ...
        jetbrains_plugin_main_kotlin_com_riwaq_arch_actions_StartServerAction[jetbrains-plugin/main/kotlin/com/riwaq/arch/actions/StartServerAction]
        jetbrains_plugin_main_kotlin_com_riwaq_arch_toolwindow_ArchitecturePanel[jetbrains-plugin/main/kotlin/com/riwaq/arch/toolwindow/ArchitecturePanel]
        ...
        jetbrains_plugin_main_kotlin_com_riwaq_arch_toolwindow_DiagramPanel[jetbrains-plugin/main/kotlin/com/riwaq/arch/toolwindow/DiagramPanel]
        ...
        jetbrains_plugin_main_kotlin_com_riwaq_arch_actions_AnalyzeProjectAction[jetbrains-plugin/main/kotlin/com/riwaq/arch/actions/AnalyzeProjectAction]
        jetbrains_plugin_main_kotlin_com_riwaq_arch_toolwindow_ModulesPanel[jetbrains-plugin/main/kotlin/com/riwaq/arch/toolwindow/ModulesPanel]
        jetbrains_plugin_main_kotlin_com_riwaq_arch_actions_StopServerAction[jetbrains-plugin/main/kotlin/com/riwaq/arch/actions/StopServerAction]
    end
